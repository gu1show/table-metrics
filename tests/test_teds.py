import pytest
from table_metrics import teds_score
...
class TestTeds:
    ...
    def test_same_table(self):
        ...
        """
        assert teds_score(html_table, html_table) == 1
